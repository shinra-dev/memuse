...
So as you might have guessed from Section~\ref{howuse}, the \code{memuse} object is full of options you will never use.  The full specification for a \code{memuse} object 
